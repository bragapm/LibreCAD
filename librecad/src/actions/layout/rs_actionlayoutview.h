 ...
 */
class RS_ActionLayoutView : public RS_ActionInterface {
    Q_OBJECT
public:
    RS_ActionLayoutView(LC_ActionContext *actionContext);
    ~RS_ActionLayoutView() override;
