...
**
**********************************************************************/
#ifndef QG_LayoutOptions_H
#define QG_LayoutOptions_H

#include "lc_actionoptionswidgetbase.h"

class RS_ActionInterface;
class RS_ActionLayoutView;

namespace Ui {
    class Ui_LayoutOptions;
}

class QG_LayoutOptions : public LC_ActionOptionsWidgetBase{
    Q_OBJECT
public:
    QG_LayoutOptions();
    ~QG_LayoutOptions() override;
...
protected:
    RS_ActionLayoutView* m_action = nullptr;
...
private:
    ...
    std::unique_ptr<Ui::Ui_LayoutOptions> ui;
